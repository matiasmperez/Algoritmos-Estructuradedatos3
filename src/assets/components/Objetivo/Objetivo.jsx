...
function Objetivo() {
  return (
    <>
      ...
      <h3>Algoritmos y Estructuras de Datos I:</h3>
      <p>
        Este módulo se propone acercar a los alumnos adquirir herramientas para
        resolver problemas por medio de algoritmos y su respectiva
        representación a través de estructura de datos. Para ello, se trabaja a
        partir de diferentes situaciones problemáticas y se busca encontrar
        ...
        <ul>
          ...
          <li>
            Implementar los algoritmos y representarlos a través de estructuras
            de datos.
          </li>
          <li>
            Incorporar la abstracción para modelizar datos de un problema en una
            estructura.
          </li>
        </ul>
      </p>
      <h3>Algoritmos y Estructuras de Datos II:</h3>
      <p>
        ...
        capaces de:
        <ul>
          <li>Conocer los distintos paradigmas de la programación. </li>
          <li>
            Conocer y utilizar el paradigma de objetos, sus características,
            ventajas y aplicaciones dentro del desarrollo de sistemas.
          </li>
          <li> Adquirir técnicas de resolución de problemas reales. </li>
          <li>Diseñar aplicaciones con frameworks orientado a objetos.</li>
        </ul>
      </p>
      <h3>Algoritmos y Estructuras de Datos III:</h3>
      <p>
        Este módulo presenta una profundización de la materia Algoritmos y
        estructura de datos I y II. Se conoce que el mundo real tiene problemas
        que no se pueden modelar con estructuras de datos simples, por eso es
        que se requieren de estructuras no lineales y recursivas. En esta
        materia se abordan esas estructuras de datos, sus fundamentos
        matemáticos y utilización. Asimismo, se abordaran estructuras de datos
